...
('client2','pass2','http://localhost','authorization_code','file node userinfo cloud','nft'),
('testclient','testpass','http://localhost','client_credentials password authorization_code refresh_token','file node userinfo cloud','nft');
...
('user','pass','nft','grasses'),
('username','password','nft','grasses');
