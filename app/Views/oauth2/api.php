        ...
        <form class="form-inline">
            ...
            <div class="form-group">
                <label for="authorize">
                    ...
                    <div>code参数 请通过`<a target="_blank" href="/authorize?response_type=code&client_id=testclient&redirect_uri=http://homeway.me/&state=xyz&scope=">/authorize?response_type=code&client_id=testclient&redirect_uri=http://homeway.me/&state=xxx&scope=</a>`跳转后取得。</div><br>
                </label><br>
...
$(document).ready(function(){
    ...
    $('#btn-authorize').click(function (e){
        var data = {code: $("#authorize-code").val(), client_id: 'testclient', client_secret:'testpass', redirect_uri:"http://homeway.me/", grant_type: 'authorization_code', scope:'file node userinfo cloud'};
        console.log(data);
